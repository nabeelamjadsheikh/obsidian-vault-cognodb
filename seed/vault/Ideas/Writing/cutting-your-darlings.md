...
The gentle part matters. Deleting a good sentence outright feels like loss and produces resistance, and resistance produces self-indulgent drafts. So I cut into a file instead of into the void. A darling in the offcuts file is not dead, it is between jobs. Half of them turn out to belong to a different piece; the other half look inert a month later, which is its own verdict.

The reliable test is structural, not aesthetic. Read the paragraph without the darling. If nothing is lost except pleasure, it goes. This only works if you already know what the piece is about, which is why [[Revision Is Re-Seeing]] has to come first — you cannot judge whether a sentence earns its place until you know what the place is for.
