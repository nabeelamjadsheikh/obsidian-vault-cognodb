...
The reliable illustration is the bathtub. If the tap runs faster than the drain, the level rises — even if the tap is slowing down. "The deficit is falling" and "the debt is rising" are both true simultaneously, and most of the argument about them is people refusing to notice that one is a flow and the other is a stock.

Two properties of stocks that break intuition:

- **Stocks change slowly even when flows change instantly.** You can shut the tap off completely and the bath is still full. This is why so many interventions appear to fail: the flow was fixed, the stock has not drained yet.
- **Stocks are memory.** They are why a system's history constrains its present, and why identical policies produce different results in two organisations.
